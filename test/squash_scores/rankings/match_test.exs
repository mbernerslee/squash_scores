defmodule SquashScores.Rankings.MatchTest do
  ...
  describe "record/5" do
    test "with a winner" do
      pre_match_scores =
        [
          %{player: "Dave", wins: 0, losses: 0, draws: 0, elo: 1500},
          %{player: "Mary", wins: 0, losses: 0, draws: 0, elo: 1500},
          %{player: "Jim", wins: 0, losses: 0, draws: 0, elo: 1500},
          %{player: "Jenny", wins: 0, losses: 0, draws: 0, elo: 1500},
        ]
      ...
      post_match_scores =
        [
          %{player: "Jim", wins: 1, losses: 0, draws: 0, elo: 1516},
          %{player: "Dave", wins: 0, losses: 1, draws: 0, elo: 1484},
          %{player: "Mary", wins: 0, losses: 0, draws: 0, elo: 1500},
          %{player: "Jenny", wins: 0, losses: 0, draws: 0, elo: 1500},
        ]
    ...
    test "with a winner, with different starting elos" do
      pre_match_scores =
        [
          %{player: "Dave", wins: 0, losses: 0, draws: 0, elo: 1000},
          %{player: "Mary", wins: 0, losses: 0, draws: 0, elo: 1950},
        ]

      post_match_scores =
        [
          %{player: "Dave", wins: 1, losses: 0, draws: 0, elo: 1032},
          %{player: "Mary", wins: 0, losses: 1, draws: 0, elo: 1918},
        ]
    ...
    test "with a draw, with different starting elos" do
      pre_match_scores =
        [
          %{player: "Dave", wins: 0, losses: 0, draws: 0, elo: 1800},
          %{player: "Mary", wins: 0, losses: 0, draws: 0, elo: 1500},
        ]

      post_match_scores =
        [
          %{player: "Dave", wins: 0, losses: 0, draws: 1, elo: 1789},
          %{player: "Mary", wins: 0, losses: 0, draws: 1, elo: 1511},
        ]
